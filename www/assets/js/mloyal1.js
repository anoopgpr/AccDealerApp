	...
	var ihbpincode = $('#tx_ihbpincode').val();
	 ...
	 $.ajax({
			   ...
			   success: function(data, textStatus, xhr) {	
					   ...
					   {
							add_new_site(ihbmobile,ihbname,ihbaddress,mobileno);
					   }
			   },
			   error: function(xhr, textStatus, errorThrown) {
...
function add_new_site(ihbmobile,ihbname,ihbaddress,cmobileno)
{
	$.ajax({
...
{
	// var xihbmobile1 = $('#update_rcount_ihbmobile1').val();
	// var xihbname1 = $('#update_rcount_ihbname1').val();
	// var xihbaddress1 = $('#update_rcount_ihbaddress1').val();
	// var xihbpotential1 = $('#update_rcount_ihbpotential1').val();
    // var runningsite1 = '{"ihbmobile1":' +'"'+ xihbmobile1 +'"'+',"ihbname1":'+'"'+ xihbname1 +'"'+',"ihbaddress1":'+'"'+ xihbaddress1 +'"'+',"ihbpotential1":'+'"'+ xihbpotential1 +'"'+'}'
	
	var runsitenum = $('#update_runningsite_count').val();
	console.log(runsitenum + ' ' + submitformnum);
	if(runsitenum == submitformnum){
	// console.log(runningsite1 +' '+ runningsite2  +' '+ runningsite3  +' '+ runningsite4  +' '+ runningsite5);
	...
	var aadharno = $('#update_aadharno_de').val();
	...
	var doctype = $('#update_kyc_type_de').val();
	...
	var rcount = checkforundefined($('#update_runningsite_count').val());
		...
		if(rcount== '2')
		{
			 ...
			 var ihbadd1 = $('#update_rcount_ihbaddress1').val();
			 var ihbpbags1 = $('#update_rcount_ihbpotential1').val();

			 var ihbmob2 = $('#update_rcount_ihbmobile2').val();
			 var ihbname2 = $('#update_rcount_ihbname2').val();
			 var ihbadd2 = $('#update_rcount_ihbaddress2').val();
			 var ihbpbags2 = $('#update_rcount_ihbpotential2').val();
			 
			 if(ihbmob1=='' || ihbname1=='' || ihbadd1=='' || ihbpbags1=='' || ihbmob2=='' || ihbname2=='' || ihbadd2=='' || ihbpbags2=='')
			 {
				  mandate=true;
			 }
			 else 
		...
		else if(rcount== '3')
		{
			 ...
			 var ihbmob3 = $('#update_rcount_ihbmobile3').val();
			 var ihbname3 = $('#update_rcount_ihbname3').val();
			 var ihbadd3 = $('#update_rcount_ihbaddress3').val();
			 var ihbpbags3 = $('#update_rcount_ihbpotential3').val();
			 
			 if(ihbmob1=='' || ihbname1=='' || ihbadd1=='' || ihbpbags1=='' || ihbmob2=='' || ihbname2=='' || ihbadd2=='' || ihbpbags2=='' || ihbmob3=='' || ihbname3=='' || ihbadd3=='' || ihbpbags3=='')
			 {
				  mandate=true;
			 }
			 else 
		...
		else if(rcount== '4')
		{
			 ...
			 var ihbmob4 = $('#update_rcount_ihbmobile4').val();
			 var ihbname4 = $('#update_rcount_ihbname4').val();
			 var ihbadd4 = $('#update_rcount_ihbaddress4').val();
			 var ihbpbags4 = $('#update_rcount_ihbpotential4').val();
			 
			 if(ihbmob1=='' || ihbname1=='' || ihbadd1=='' || ihbpbags1=='' || ihbmob2=='' || ihbname2=='' || ihbadd2=='' || ihbpbags2=='' || ihbmob3=='' || ihbname3=='' || ihbadd3=='' || ihbpbags3=='' || ihbmob4=='' || ihbname4=='' || ihbadd4=='' || ihbpbags4=='')
			 {
				  mandate=true;
			 }
			 else 
		...
		else if(rcount== '5')
		{
			 ...
			 var ihbmob5 = $('#update_rcount_ihbmobile5').val();
			 var ihbname5 = $('#update_rcount_ihbname5').val();
			 var ihbadd5 = $('#update_rcount_ihbaddress5').val();
			 var ihbpbags5 = $('#update_rcount_ihbpotential5').val();
			 
			 if(ihbmob1=='' || ihbname1=='' || ihbadd1=='' || ihbpbags1=='' || ihbmob2=='' || ihbname2=='' || ihbadd2=='' || ihbpbags2=='' || ihbmob3=='' || ihbname3=='' || ihbadd3=='' || ihbpbags3=='' || ihbmob4=='' || ihbname4=='' || ihbadd4=='' || ihbpbags4=='' || ihbmob5=='' || ihbname5=='' || ihbadd5=='' || ihbpbags5=='')
			 {
				  mandate=true;
			 }
			 else 
	...
	toast('Please Submit all the site Registration.');
}
}
		...
		//    console.log('JSONDATA'+JSON.stringify(data));
		   ...
		   var datalist = data.data;
			...
			for(var j=0; j< datalist.length; j++)
			{
				...
				{
				listItems+='<p onclick=existingUser_check_byse(\''+datalist[j].mobileno+'\')>'+datalist[j].CustomerName+'</p>';
...
function site_Reg(xname,xmobile,xaddress,xbags)
{
 ...
 var bags = $('#'+xbags).val();
 console.log(sname,mobile,address,bags);


 if(sname=='' || mobile=='' || address=='' || bags=='' )
 {
     toast('Please enter mandatory fields!');
 }
 else
 {
   ...
   $.ajax({
    url: SERVER2+'Site_Running_details_API.asp?apiuid=MLOYALAPI&apipswd=M0B!Q%24T%402o19&referedby='+mobileno_cont+'&Name='+sname+'&MobileNo='+mobile+'&address='+address+'&bags='+bags,
    type: 'GET',
    timeout: 50000,
    dataType: 'html',
...
{
	$.ajax({
		url: SERVER2+'get_itembrand_by_SUcode.asp?apiuid=MLOYALAPI&apipswd=Ml0yalAP!2o14&sucode=N308',
		type: 'GET',
		timeout: 30000,
		success: function(data, textStatus, xhr) {
         ...
         console.log(data);
			   ...
			   for(var i= 0; i < data.data.length; i++) 
			   {
					...
					str +='<img src="'+p_img+'" alt="" class="image">';
  ...
  function showIhbMemberList(mobileno)
  {
	$.ajax({
	   ...
	   var data1 = data.sms;
			var listItems= "";
				listItems+= "<option value=''  disabled='disabled' style='background-color:#3E3E3E'  selected='selected'>-Select IHB Member*-</option>";
				 ...
				 else
				 {
					 for (var i = 0; i < data.data.length; i++)
					 {
						 ...
						 if(data.data[i].Member_Mobile.startsWith('91'))
						 {
							...
							// str1 +='<div class="approval_block"><img src="assets/images/retailer_license_icon.png" class="location_icon"/><span class="approval_email">IHB MobileNo: '+checkforundefined(data.data[i].IHB_MobileNo)+'</span></div>';
							str1 +='<div class="approval_block"><img src="assets/images/retailer_license_icon.png" class="location_icon"/><span class="approval_email">Sale Amount: '+checkforundefined(data.data[i].SaleAmount)+'</span></div>';
							// str1 +='<div class="approval_block"><img src="assets/images/retailer_license_icon.png" class="location_icon"/><span class="approval_email">IHB Address: '+checkforundefined(data.data[i].IHB_Address)+'</span></div>';
